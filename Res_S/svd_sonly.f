      ...
      IMPLICIT NONE
*
*     This routine applies SVD and outputs singular matrices
...
*     .. Parameters ..
     ...
     $                   M = 252426, N = 36092, MB = 200, NB = 200,
     $                   RSRC = 0, CSRC = 0, MXLLDA = 252426,
     $                   NRHS = 1, NBRHS = 1, NOUT = 6,
     $                   MXLOCR = 9200, MXLOCC = 3092 )
!      PARAMETER          ( DLEN_ = 9, IA = 1, JA = 1, IU = 1, JU = 1,
!     $                   IVT = 1, JVT = 1, ISIG = 1, JSIG = 1,
!     $                   M = 314298, N = 46404, MB = 200, NB = 200,
!     $                   RSRC = 0, CSRC = 0, MXLLDA = 314298,
!     $                   NRHS = 1, NBRHS = 1, NOUT = 6,
!     $                   MXLOCR = 11400, MXLOCC = 4000 )
!      $                   MXRHSC = 1, GB = 1024*1024*1024 )
!       PARAMETER          ( DLEN_ = 9, IA = 1, JA = 1, IU = 1, JU = 1,
!      $                   IVT = 1, JVT = 1, ISIG = 1, JSIG = 1,
!      $                   M = 506, N = 13, MB = 2, NB = 2, RSRC = 0,
!      $                   CSRC = 0, MXLLDA = 254, MXLLDB = 254, NRHS = 1,
!      $                   NBRHS = 1, NOUT = 6, MXLOCR = 254, MXLOCC = 5,
!      $                   MXRHSC = 1, GB = 1024*1024*1024 )
...
!      $                   B( MXLLDB, MXRHSC ), B0( MXLLDB, MXRHSC ),
      DOUBLE PRECISION   WORK( 200000000 )
...
*
      ...
      CALL DESCINIT( DESCSIG, SIZE, SIZE, NB, NB, 0, 0, ICTXT, LDVT,
     $               INFO )

!       CALL DESCINIT( DESCA, M, N, MB, NB, RSRC, CSRC, ICTXT, MXLLDA,
!      $               INFO )
!       CALL DESCINIT( DESCU, M, N, MB, NB, RSRC, CSRC, ICTXT, MXLLDA,
!      $               INFO )
!       CALL DESCINIT( DESCVT, M, N, MB, NB, RSRC, CSRC, ICTXT, MXLLDA,
!      $               INFO )
!       CALL DESCINIT( DESCB, M, NRHS, MB, NBRHS, RSRC, CSRC, ICTXT,
!      $               MXLLDB, INFO )
*
...
*
      ...
      CALL PDLAREAD( 'double_input', WORK( PTRA ), DESCA, 0, 0,
     $                WORK(PTRWORK) )
...
*
     ...
     $                0, 0, WORK(PTRWORK) )
      CALL PDLAWRITE( 'V.out', SIZE, N, WORK( PTRVT ), IVT, JVT, DESCVT,
     $                0, 0, WORK(PTRWORK) )
